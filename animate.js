...
descriptMap.set("randwich", 'Jenn de la Vega went from picky eater to wide-eyed culinary autodidact who buries herself in archaic cookbooks, gastrophysics papers, and food science lab reports. On her menus, you\'ll find a mash-up of her Filipino-American heritage, Spanish tapas, artisanal cheese, and 90\'s inspired fast-food cuisine. She is known for her <a class="sitelink" rel="noopener noreferrer" target="_blank" href="https://www.randwich.es/">Randwiches</a> or "random sandwiches" in Brooklyn, where clients are given no choice in what they order. Outside of the food industry, Jenn serves on the Board of Directors for The Tank, a nonprofit arts presenter for emerging artists.<br><br>Here is a simple recipe from Jenn — Berry Trifle Jars.<br> <br> <a class="downloadlink" href="files/Berry_Trifle_Jars.pdf">Download</a>');
